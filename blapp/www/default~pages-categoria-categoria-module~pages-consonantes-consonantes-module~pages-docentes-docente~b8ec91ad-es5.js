  ...
  function srcAppComponentsSemanticsSemanticsGamePanelSemanticsGamePanelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(SemanticsGamePanelComponent, [{
        ...
        key: "oddPredicate",
        value: function oddPredicate(item) {
        ...
        key: "validarSujeto",
        value: function validarSujeto(item) {
          return item.data.substring(33, 39) === 'sujeto';
        }
      }, {
        key: "validarVerbo",
        value: function validarVerbo(item) {
          return item.data.substring(33, 38) === 'verbo';
        }
      }, {
        key: "validarPredicado",
        value: function validarPredicado(item) {
